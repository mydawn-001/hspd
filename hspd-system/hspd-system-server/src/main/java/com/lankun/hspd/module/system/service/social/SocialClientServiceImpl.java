package com.lankun.hspd.module.system.service.social;
...
import com.lankun.hspd.framework.common.util.cache.CacheUtils;
import com.lankun.hspd.framework.common.util.http.HttpUtils;
import com.lankun.hspd.framework.common.util.object.BeanUtils;
import com.lankun.hspd.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.lankun.hspd.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.lankun.hspd.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.lankun.hspd.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.lankun.hspd.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.lankun.hspd.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.lankun.hspd.module.system.dal.dataobject.social.SocialClientDO;
import com.lankun.hspd.module.system.dal.mysql.social.SocialClientMapper;
import com.lankun.hspd.module.system.dal.redis.RedisKeyConstants;
import com.lankun.hspd.module.system.enums.social.SocialTypeEnum;
import com.lankun.hspd.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.lankun.hspd.framework.common.util.collection.MapUtils.findAndThen;
import static com.lankun.hspd.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.lankun.hspd.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.lankun.hspd.framework.common.util.json.JsonUtils.toJsonString;
