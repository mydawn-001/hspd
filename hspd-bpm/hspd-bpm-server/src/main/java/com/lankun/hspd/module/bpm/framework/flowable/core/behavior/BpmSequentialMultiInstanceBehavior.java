package com.lankun.hspd.module.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import com.lankun.hspd.framework.common.util.collection.SetUtils;
import com.lankun.hspd.module.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        ...
        // 参见 https://gitee.com/zhijiantianya/hspd-cloud/issues/IC239F
