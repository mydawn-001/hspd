package com.lankun.hspd.module.bpm.service.task;
...
import com.lankun.hspd.framework.common.util.collection.CollectionUtils;
import com.lankun.hspd.framework.common.util.date.DateUtils;
import com.lankun.hspd.framework.common.util.json.JsonUtils;
import com.lankun.hspd.framework.common.util.object.ObjectUtils;
import com.lankun.hspd.framework.common.util.object.PageUtils;
import com.lankun.hspd.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.lankun.hspd.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.lankun.hspd.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.lankun.hspd.module.bpm.controller.admin.task.vo.instance.*;
import com.lankun.hspd.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.lankun.hspd.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.lankun.hspd.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.lankun.hspd.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.lankun.hspd.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.lankun.hspd.module.bpm.enums.ErrorCodeConstants;
import com.lankun.hspd.module.bpm.enums.definition.BpmModelTypeEnum;
import com.lankun.hspd.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.lankun.hspd.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.lankun.hspd.module.bpm.enums.task.BpmReasonEnum;
import com.lankun.hspd.module.bpm.enums.task.BpmTaskStatusEnum;
import com.lankun.hspd.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.lankun.hspd.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.lankun.hspd.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.lankun.hspd.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.lankun.hspd.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.lankun.hspd.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.lankun.hspd.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.lankun.hspd.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.lankun.hspd.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.lankun.hspd.module.bpm.service.definition.BpmProcessDefinitionService;
import com.lankun.hspd.module.bpm.service.message.BpmMessageService;
...
import static com.lankun.hspd.framework.common.util.collection.CollectionUtils.*;
import static com.lankun.hspd.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.lankun.hspd.module.bpm.enums.ErrorCodeConstants.*;
import static com.lankun.hspd.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.lankun.hspd.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_NEED_SIMULATE_PREFIX;
import static com.lankun.hspd.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
