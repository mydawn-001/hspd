package com.lankun.hspd.framework.tenant.config;

import cn.hutool.extra.spring.SpringUtil;
import com.lankun.hspd.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.lankun.hspd.framework.redis.config.YudaoCacheProperties;
import com.lankun.hspd.framework.security.core.service.SecurityFrameworkService;
import com.lankun.hspd.framework.tenant.core.aop.TenantIgnore;
import com.lankun.hspd.framework.tenant.core.aop.TenantIgnoreAspect;
import com.lankun.hspd.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.lankun.hspd.framework.tenant.core.job.TenantJobAspect;
import com.lankun.hspd.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.lankun.hspd.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.lankun.hspd.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.lankun.hspd.framework.tenant.core.redis.TenantRedisCacheManager;
import com.lankun.hspd.framework.tenant.core.security.TenantSecurityWebFilter;
import com.lankun.hspd.framework.tenant.core.service.TenantFrameworkService;
import com.lankun.hspd.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.lankun.hspd.framework.tenant.core.web.TenantContextWebFilter;
import com.lankun.hspd.framework.tenant.core.web.TenantVisitContextInterceptor;
...
public class YudaoTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/hspd-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "com.lankun.hspd.framework.mq.redis.core.RedisMQTemplate")
